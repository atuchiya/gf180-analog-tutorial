...
N 680 -370 680 -320 {lab=inn}
N 680 -260 680 -220 {lab=GND}
N 610 -370 680 -370 {lab=inn}
...
C {devices/vsource.sym} 250 -290 0 0 {name=Vinp value="sin voff vamp fsig 0 0 0" savecurrent=false}
...
C {devices/vsource.sym} 680 -290 0 0 {name=Vinn value="sin voff vamp fsig 0 0 phasen" savecurrent=false}
...
C {lab_pin.sym} 250 -370 0 0 {name=p5 sig_type=std_logic lab=inp}
C {lab_pin.sym} 680 -370 0 1 {name=p6 sig_type=std_logic lab=inn}
