...
* ID-VGS
dc VGS 0 3.3 0.01
write nfet_03v3_dc_idvgs.raw

* ID-VGS (w/ body biasing)
dc VGS 0 3.3 0.01 VBS -3.3 0.6 0.5
write nfet_03v3_dc_idvgs_body.raw

* ID-VDS
dc VDS 0 3.3 0.01 VGS 0 3.3 0.5
write nfet_03v3_dc_idvds.raw
.endc
"}
...
C {devices/launcher.sym} 545 -685 0 0 {name=h2
descr="ID-VDS curve"
tclcommand="
xschem raw_read $netlist_dir/[file tail [file rootname [xschem get current_name]]]_idvds.raw
"
}
C {devices/launcher.sym} 545 -725 0 0 {name=h3
descr="ID-VGS curve (w/ body biasing)"
tclcommand="
xschem raw_read $netlist_dir/[file tail [file rootname [xschem get current_name]]]_idvgs_body.raw
"
}
